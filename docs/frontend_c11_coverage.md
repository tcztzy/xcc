...
- **Core preprocessor behavior**
  ...
  - Include search precedence is validated (`"..."` prefers source directory; `<...>` resolves via include paths), with cycle/read diagnostics; cycle failures now include the concrete include chain (`a.h -> b.h -> a.h`) for faster root-cause triage.
...
- **Predefined macro coverage (current)**
  - `__STDC__`, `__STDC_HOSTED__`, `__STDC_VERSION__`, `__STDC_IEC_559__`, `__STDC_MB_MIGHT_NEQ_WC__`, `__STDC_UTF_16__`, `__STDC_UTF_32__`, `__STDC_NO_ATOMICS__`, `__STDC_NO_COMPLEX__`, `__STDC_NO_THREADS__`, `__STDC_NO_VLA__`, `__STDC_ISO_10646__`, `__FILE__`, `__BASE_FILE__`, `__LINE__`, `__INCLUDE_LEVEL__`, `__COUNTER__`, `__DATE__`, `__TIME__`.
  - Target-assumption baseline macros for LP64 little-endian hosts are included and regression-tested (`__LP64__`, `__CHAR_BIT__`, `__SIZEOF_SHORT__`, `__SIZEOF_INT__`, `__SIZEOF_POINTER__`, `__SIZEOF_LONG__`, `__SIZEOF_LONG_LONG__`, `__ORDER_LITTLE_ENDIAN__`, `__ORDER_BIG_ENDIAN__`, `__BYTE_ORDER__`, `__LITTLE_ENDIAN__`, `__BIG_ENDIAN__`, `__FLOAT_WORD_ORDER__`, `__SIZE_TYPE__`, `__PTRDIFF_TYPE__`, `__WCHAR_TYPE__`, `__WINT_TYPE__`, `__WCHAR_WIDTH__`, `__WINT_WIDTH__`).
  - Integer width/value assumptions are also predefined and regression-tested (`__INT_WIDTH__`, `__LONG_WIDTH__`, `__LONG_LONG_WIDTH__`, `__INTMAX_WIDTH__`, `__UINTMAX_WIDTH__`, `__SIZE_WIDTH__`, `__PTRDIFF_WIDTH__`, `__SCHAR_MAX__`, `__SHRT_MAX__`, `__INT_MAX__`, `__LONG_MAX__`, `__LONG_LONG_MAX__`, `__INTMAX_MAX__`, `__UCHAR_MAX__`, `__USHRT_MAX__`, `__UINT_MAX__`, `__ULONG_MAX__`, `__SIZE_MAX__`, `__PTRDIFF_MAX__`, `__UINTMAX_MAX__`).
