...
- **Predefined macro coverage (current)**
  ...
  - Floating-format target assumptions are predefined and regression-tested (`__FLT_RADIX__`, `__FLT_MANT_DIG__`, `__DBL_MANT_DIG__`, `__LDBL_MANT_DIG__`, `__FLT_DIG__`, `__DBL_DIG__`, `__LDBL_DIG__`, `__FLT_MIN_EXP__`, `__DBL_MIN_EXP__`, `__LDBL_MIN_EXP__`, `__FLT_MAX_EXP__`, `__DBL_MAX_EXP__`, `__LDBL_MAX_EXP__`).
