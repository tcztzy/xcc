...
- **Predefined macro coverage (current)**
  ...
  - Integer width/value assumptions are also predefined and regression-tested (`__INT_WIDTH__`, `__LONG_WIDTH__`, `__LONG_LONG_WIDTH__`, `__SIZE_WIDTH__`, `__PTRDIFF_WIDTH__`, `__SCHAR_MAX__`, `__SHRT_MAX__`, `__INT_MAX__`, `__LONG_MAX__`, `__LONG_LONG_MAX__`, `__INTMAX_MAX__`, `__UCHAR_MAX__`, `__USHRT_MAX__`, `__UINT_MAX__`, `__ULONG_MAX__`, `__SIZE_MAX__`, `__PTRDIFF_MAX__`, `__UINTMAX_MAX__`).
