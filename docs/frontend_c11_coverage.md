...
- **Predefined macro coverage (current)**
  ...
  - Mode-specific predefined macro split is covered: strict `c11` defines `__STRICT_ANSI__`, while `gnu11` defines GNU compatibility version macros (`__GNUC__`, `__GNUC_MINOR__`, `__GNUC_PATCHLEVEL__`, `__VERSION__`).
  - Target-assumption baseline macros for LP64 little-endian hosts are included and regression-tested (`__LP64__`, `__LP64`, `_LP64`, `__CHAR_BIT__`, `__SIZEOF_SHORT__`, `__SIZEOF_INT__`, `__SIZEOF_POINTER__`, `__SIZEOF_LONG__`, `__SIZEOF_LONG_LONG__`, `__SIZEOF_SIZE_T__`, `__SIZEOF_PTRDIFF_T__`, `__SIZEOF_INTMAX_T__`, `__SIZEOF_UINTMAX_T__`, `__SIZEOF_WCHAR_T__`, `__SIZEOF_WINT_T__`, `__ORDER_LITTLE_ENDIAN__`, `__ORDER_BIG_ENDIAN__`, `__BYTE_ORDER__`, `__LITTLE_ENDIAN__`, `__BIG_ENDIAN__`, `__FLOAT_WORD_ORDER__`, `__SIZE_TYPE__`, `__PTRDIFF_TYPE__`, `__INTPTR_TYPE__`, `__UINTPTR_TYPE__`, fixed-width integer type families `__INT{8,16,32,64}_TYPE__` / `__UINT{8,16,32,64}_TYPE__`, least-width aliases `__INT_LEAST{8,16,32,64}_TYPE__` / `__UINT_LEAST{8,16,32,64}_TYPE__`, fast-width aliases `__INT_FAST{8,16,32,64}_TYPE__` / `__UINT_FAST{8,16,32,64}_TYPE__`, `__WCHAR_TYPE__`, `__WINT_TYPE__`, `__WCHAR_WIDTH__`, `__WINT_WIDTH__`, `__WCHAR_MAX__`, `__WCHAR_MIN__`, `__WINT_MAX__`, `__WINT_MIN__`, `__SIG_ATOMIC_TYPE__`, `__SIG_ATOMIC_WIDTH__`, `__SIG_ATOMIC_MAX__`, `__SIG_ATOMIC_MIN__`).
  - Integer width/value assumptions are also predefined and regression-tested (`__INT_WIDTH__`, `__LONG_WIDTH__`, `__LONG_LONG_WIDTH__`, `__LLONG_WIDTH__`, `__INTMAX_WIDTH__`, `__UINTMAX_WIDTH__`, `__SIZE_WIDTH__`, `__PTRDIFF_WIDTH__`, `__INTPTR_WIDTH__`, `__UINTPTR_WIDTH__`, `__SCHAR_MAX__`, `__SCHAR_MIN__`, `__SHRT_MAX__`, `__SHRT_MIN__`, `__INT_MAX__`, `__INT_MIN__`, `__LONG_MAX__`, `__LONG_MIN__`, `__LONG_LONG_MAX__`, `__LONG_LONG_MIN__`, `__LLONG_MAX__`, `__LLONG_MIN__`, `__INTMAX_MAX__`, `__INTMAX_MIN__`, `__INTPTR_MAX__`, `__INTPTR_MIN__`, `__UCHAR_MAX__`, `__USHRT_MAX__`, `__UINT_MAX__`, `__ULONG_MAX__`, `__ULLONG_MAX__`, `__SIZE_MAX__`, `__PTRDIFF_MAX__`, `__PTRDIFF_MIN__`, `__UINTPTR_MAX__`, `__UINTMAX_MAX__`).
  - Floating-format target assumptions are predefined and regression-tested (`__FLT_RADIX__`, `__FLT_MANT_DIG__`, `__DBL_MANT_DIG__`, `__LDBL_MANT_DIG__`, `__FLT_DIG__`, `__DBL_DIG__`, `__LDBL_DIG__`, `__FLT_EPSILON__`, `__DBL_EPSILON__`, `__LDBL_EPSILON__`, `__FLT_MIN__`, `__DBL_MIN__`, `__LDBL_MIN__`, `__FLT_MAX__`, `__DBL_MAX__`, `__LDBL_MAX__`, `__FLT_MIN_EXP__`, `__DBL_MIN_EXP__`, `__LDBL_MIN_EXP__`, `__FLT_MAX_EXP__`, `__DBL_MAX_EXP__`, `__LDBL_MAX_EXP__`).
