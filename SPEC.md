...
## §G GOAL
Python stdlib-only C11 compiler with target-driven codegen; default `llvm`, and `--target=aarch64-apple-darwin` can compile CPython to a native executable that runs on this machine.
