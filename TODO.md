...
- Next target: add curated clang-manifest parser fixtures for trailing-comma and non-terminal-ellipsis parameter-list diagnostics so external fixture coverage matches these new local parser regressions.
