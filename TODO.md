...
- Next target: continue parser diagnostic hardening by splitting unsupported type diagnostics for non-identifier tokens into finer token-category wording (e.g., unsupported keyword vs non-keyword token shapes) without changing parse acceptance.
