...
- Next target: add a curated clang-manifest regression case for declaration type-start `%:%:` digraph coverage to continue declaration token-shape parity in the external fixture suite.
