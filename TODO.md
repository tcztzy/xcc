...
- Next target: continue parser diagnostic hardening by splitting remaining generic array-size non-ICE fallbacks (for example `GenericExpr` and comma-expression paths) into context-specific parser diagnostics.
