...
- Next target: apply the same context-aware diagnostic pattern to `Invalid storage class for parameter` so the offending storage-class keyword is included in parser errors without changing accepted grammar.
