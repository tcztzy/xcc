...
- Next target: add sibling block/member-context coverage for these parameter-list diagnostics in function-pointer declarators (non-typedef declaration forms) so direct and pointer declarator paths are both locked down across nested scopes.
