...
- Next target: add the nested-function-body sibling fixture (`int main(){int (*fp)(...);return 0;}`) to lock down the same parser diagnostic path in block-scope declarator context.
