...
- Next target: add curated clang-manifest regression cases for declaration/type-name type-start `++` and `--` punctuator diagnostics so external fixture coverage matches the new local parser assertions.
